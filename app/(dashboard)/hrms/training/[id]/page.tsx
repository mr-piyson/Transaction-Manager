...
export default function TrainingDetailPage() {
	...
	const {
		...
		isLoading,
		isError,
	} = trpc.hr.training.byId.useQuery(
		{ id: params.id },
		{ enabled: !!params.id },
	);
			...
			<div className="flex items-center justify-center h-[60vh]">
				<Empty>
					<EmptyHeader>
						...
						<EmptyDescription>
							The training program you're looking for doesn't exist or has been
							deleted.
						</EmptyDescription>
					</EmptyHeader>
				</Empty>
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-4">
						<Button
							variant="ghost"
							size="icon"
							onClick={() => router.push("/hrms/training")}
						>
						...
						<div>
							<div className="flex items-center gap-2">
								...
								<Badge
									variant="outline"
									className={STATUS_COLORS[training.status] ?? ""}
								>
							...
							<p className="text-sm text-muted-foreground">
								...
								{training.cost != null && (
									<span> · {Number(training.cost).toFixed(3)}</span>
								)}
								{training.startDate && (
									<span>
										{" "}
			...
			<Dialog open={enrollDialogOpen} onOpenChange={setEnrollDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Select an employee to enroll in this training program.
						</DialogDescription>
					</DialogHeader>
				...
				<DialogContent>
					...
					<DialogFooter>
						...
						<Button
							...
							disabled={
								updateEnrollmentStatusMutation.isPending || !updateStatusValue
							}
						>
							{updateEnrollmentStatusMutation.isPending && (
								<Loader2 className="mr-2 size-4 animate-spin" />
