...
export default function CandidatesPage() {
	...
	const { data, isLoading, refetch } =
		trpc.hr.recruitment.candidates.list.useQuery({
			page,
			limit,
	...
	const updateStatusMutation =
		trpc.hr.recruitment.candidates.updateStatus.useMutation({
			onSuccess: () => {
				refetch();
			...
			{isLoading ? (
				...
				<div className="flex items-center justify-center py-20">
					<Empty>
						<EmptyHeader>
							<EmptyMedia>
								<UserPlus className="size-16 text-muted-foreground" />
							</EmptyMedia>
			...
			<Dialog open={statusDialogOpen} onOpenChange={setStatusDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Change the candidate&apos;s current status.
						</DialogDescription>
					</DialogHeader>
