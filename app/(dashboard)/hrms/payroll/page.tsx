								...
								<TableBody>
									{records.map((record: any) => (
										...
										>
											...
											<TableCell>
												{record._count?.items ?? record.items?.length ?? 0}
											</TableCell>
											<TableCell className="font-mono text-sm">
												{record.totalSalary != null
													? Number(record.totalSalary).toFixed(3)
													: "—"}
											</TableCell>
											<TableCell className="font-mono text-sm">
												{record.totalDeductions != null
													? Number(record.totalDeductions).toFixed(3)
													: "—"}
											</TableCell>
											<TableCell className="font-mono text-sm">
												{record.totalNet != null
													? Number(record.totalNet).toFixed(3)
													: "—"}
											</TableCell>
											...
											<TableCell onClick={(e) => e.stopPropagation()}>
												<DropdownMenu>
													...
													<DropdownMenuContent align="end">
														<DropdownMenuItem
															onClick={() =>
																router.push(`/hrms/payroll/${record.id}`)
															}
														>
															View Details
														</DropdownMenuItem>
