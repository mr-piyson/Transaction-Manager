...
import { Supplier_List_Item } from './supplier-list-item';

type SupplierLayoutProps = {
  children?: React.ReactNode;
};

export default function SupplierLayout(props: SupplierLayoutProps) {
            ...
            >
              ...
              <aside className="flex h-full flex-col overflow-hidden border-r">
                <div className="flex gap-2 px-4 pt-4 ">
                  <SupplierFormDialog className="w-full" variant="secondary" />
                </div>
