...
import { Job_List_Item } from './job-item-list';
...
export default function CustomerLayout(props: CustomerLayoutProps) {
  const title = 'Jobs';
  const { data, isPending } = trpc.jobs.getJobs.useQuery();
        ...
        <ResizablePanelGroup className="h-full">
                ...
                <div className="flex-1 overflow-y-auto">
                  <ListView
                    ...
                    cardRenderer={(data) => (
                      ...
                      >
                        <Job_List_Item data={data as any} selectable />
                      </Link>
                    )}
                  />
                </div>
          ...
          {(!isListView || !isMobile) && (
            ...
            >
              ...
              */}
              <main className="h-full w-full overflow-y-auto p-4">{props.children}</main>
            </ResizablePanel>
          )}
        </ResizablePanelGroup>
      </div>
