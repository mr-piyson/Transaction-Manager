        ...
        <Card className="shadow-xl border-destructive/50">
          <CardHeader className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              This will permanently delete ALL data including organizations,
              users, invoices, and all records across the entire system. System
              permissions and roles will be re-seeded automatically.
            </p>
          </CardHeader>
