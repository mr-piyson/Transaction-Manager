...
export default function DateTimePage() {
  ...
  const [selectedInputFormat, setSelectedInputFormat] =
    useState<DateInputFormat>(DEFAULT_INPUT_FORMAT);
  const [selectedDisplayFormat, setSelectedDisplayFormat] =
    useState<DateDisplayFormat>(DEFAULT_DISPLAY_FORMAT);
    ...
    <div className="h-full space-y-6">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {(Object.keys(DATE_INPUT_FORMAT_LABELS) as DateInputFormat[]).map(
            (fmt) => {
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {(Object.keys(DATE_DISPLAY_FORMAT_LABELS) as DateDisplayFormat[]).map(
            (fmt) => {
