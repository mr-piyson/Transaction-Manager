...
export default function CustomersLayout({
  ...
  const deleteMutation = trpc.customers.delete.useMutation({
    onSuccess: () => {
      ...
      if (activeItem) router.push("/erp/customers");
    },
      ...
      const menuItems: ContextMenuItemSchema[] = [
        {
          ...
          icon: Eye,
          onClick: () => router.push(`/erp/customers/${item.id}`),
        },
        {
          id: "edit",
          label: t("common.edit"),
          ...
          onClick: () =>
            openEdit(
              ...
              {
                onSuccess: () =>
                  utils.customers.byId.invalidate({ id: item.id }),
              },
            ),
        },
  ...
  return (
    <AuthGuard permission="customer:read" subject="Customer">
