	...
	return (
		<div className="flex items-start gap-4 mb-4 relative">
			<div className="flex flex-col items-center shrink-0">
				...
				{!isLast && (
					<div className="w-0.5 flex-1 min-h-12 bg-linear-to-b from-primary/40 to-primary/5 mt-2" />
				)}
			</div>
						...
						<WorkflowStep
							...
							stats={[
								...
								},
								{
									...
									value: summary
										? currencyFormat(summary.purchases.total)
										: "—",
								},
							]}
						/>
						...
						<WorkflowStep
							...
							stats={[
								...
								},
								{
									...
									value: summary
										? currencyFormat(summary.outstanding.total)
										: "—",
								},
							]}
							isLast
						...
						<CardHeader className="pb-3 flex flex-row items-center justify-between">
							<div>
								<CardTitle className="text-sm font-bold flex items-center gap-2">
									...
									{t("dashboard.recentPOs")}
								</CardTitle>
								<CardDescription>
									{t("dashboard.recentPOsDesc")}
								</CardDescription>
							</div>
							<Button
								variant="ghost"
