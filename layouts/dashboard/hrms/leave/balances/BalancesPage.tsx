			...
			{isLoading ? (
				...
				<div className="flex items-center justify-center py-20">
					<Empty>
						<EmptyHeader>
							<EmptyMedia>
								<Calculator className="size-16 text-muted-foreground" />
							</EmptyMedia>
							<EmptyTitle>No leave balances</EmptyTitle>
							<EmptyDescription>
								Allocate leave to employees to get started.
							</EmptyDescription>
						</EmptyHeader>
					</Empty>
				</div>
			...
			<Dialog open={adjustDialogOpen} onOpenChange={setAdjustDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Add or subtract days from this balance. Use negative values to
							deduct.
						</DialogDescription>
					</DialogHeader>
					...
					<DialogFooter>
						...
						<Button
							onClick={() => {
								if (!adjustmentDays) {
									toast.error("Enter adjustment days");
									return;
								}
