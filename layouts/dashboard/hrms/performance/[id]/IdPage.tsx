...
export default function PerformanceDetailPage() {
	...
	const {
		...
		isError,
		refetch,
	} = trpc.hr.performance.byId.useQuery(
		{ id: params.id },
		{ enabled: !!params.id },
	);
			...
			<div className="flex items-center justify-center h-[60vh]">
				<Empty>
					<EmptyHeader>
						...
						<EmptyDescription>
							The performance review you're looking for doesn't exist or has
							been deleted.
						</EmptyDescription>
					</EmptyHeader>
				</Empty>
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-4">
						<Button
							variant="ghost"
							size="icon"
							onClick={() => router.push("/hrms/performance")}
						>
						...
						{review.status === "DRAFT" && (
							<>
								<Button
									...
									size="sm"
									onClick={() =>
										openEdit({ id: review.id }, { onSuccess: () => refetch() })
									}
								>
