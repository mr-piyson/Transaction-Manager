...
export default function DisciplinaryPage() {
	...
	const { data, isLoading, refetch } =
		trpc.hr.employeeRelations.disciplinaryActions.list.useQuery({
			page,
			limit,
	...
	const deleteMutation =
		trpc.hr.employeeRelations.disciplinaryActions.delete.useMutation({
			onSuccess: () => {
				refetch();
				...
				<div className="flex items-center justify-center py-20">
					<Empty>
						<EmptyHeader>
							...
							<EmptyDescription>
								No disciplinary actions found for the selected filters.
							</EmptyDescription>
						</EmptyHeader>
					</Empty>
				</div>
												...
												<DropdownMenu>
													...
													<DropdownMenuContent align="end">
														<DropdownMenuItem
															...
															onClick={() => {
																if (confirm("Delete this disciplinary action?"))
