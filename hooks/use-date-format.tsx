...
export function DateFormatProvider({
	...
	const formatDate = useCallback(
		(date: Date | string | number | null | undefined) =>
			fmtDate(date, displayFormat),
		[displayFormat],
	);

	const formatDateTime = useCallback(
		(date: Date | string | number | null | undefined) =>
			fmtDateTime(date, displayFormat),
		[displayFormat],
	);

	const formatDateTimeSeconds = useCallback(
		(date: Date | string | number | null | undefined) =>
			fmtDateTimeSec(date, displayFormat),
		[displayFormat],
	);
	...
	const formatDateForInputFn = useCallback(
		(date: Date | string | number | null | undefined) =>
			fmtDateForInput(date, inputFormat),
		[inputFormat],
	);
	...
	const formatDateTimeForInputFn = useCallback(
		(date: Date | string | number | null | undefined) =>
			fmtDateTimeForInput(date, inputFormat),
		[inputFormat],
	);
