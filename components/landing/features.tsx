			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="mt-4 text-muted-foreground">
						A complete ERP suite designed for growing companies. Powerful
						financial tools without the complexity — each module works together
						seamlessly.
					</p>
				</motion.div>
							...
							<motion.div key={feature.title} variants={cardVariants}>
								...
								>
									...
									>
										<div
											className={cn(
												"absolute -right-6 -top-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100",
												palette.watermark,
											)}
										>
										...
										<div
											className={cn(
												"flex size-11 items-center justify-center rounded-xl text-white shadow-xs ring-4",
												palette.iconBg,
												palette.iconRing,
											)}
										>
