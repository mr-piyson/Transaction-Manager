					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						...
						<Field orientation="vertical">
							...
							<Select
								...
								onValueChange={(v) =>
									setValue("isRecurringAnnual", v === "true", {
										shouldValidate: true,
									})
								}
							>
...
const HolidayFormContext = React.createContext<HolidayFormContextValue | null>(
	null,
);
...
export function HolidayFormProvider({
	children,
}: {
...
export function useHolidayForm(): HolidayFormContextValue {
	...
	if (!ctx)
		throw new Error("useHolidayForm must be used inside <HolidayFormProvider>");
	return ctx;
}
