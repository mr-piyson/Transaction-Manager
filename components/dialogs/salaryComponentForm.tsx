...
const SalaryComponentFormContext =
	React.createContext<SalaryComponentFormContextValue | null>(null);
...
export function SalaryComponentFormProvider({
	children,
}: {
...
export function useSalaryComponentForm(): SalaryComponentFormContextValue {
	...
	if (!ctx)
		throw new Error(
			"useSalaryComponentForm must be used inside <SalaryComponentFormProvider>",
		);
	return ctx;
}
