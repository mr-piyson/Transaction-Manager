...
export function MasterTab({ form, canManageMaster }: MasterTabProps) {
  ...
  const isLocked =
    !canManageMaster || mode === "existing" || mode === "add-supplier";
      ...
      <div className="grid grid-cols-2 gap-3">
        <Field>
          ...
          <div className="flex gap-2">
            <Input
              ...
              className={cn(
                "flex-1",
                errors.master.sku && "border-destructive",
              )}
            />
        ...
        <Field>
          ...
          <Input
            ...
            onChange={(e) =>
              setMasterField("barcode", e.target.value || undefined)
            }
            disabled={isLocked}
          />
        </Field>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Field>
          ...
          <Select
            value={master.type}
            onValueChange={(v) =>
              setMasterField("type", v as "PRODUCT" | "SERVICE")
            }
            disabled={isLocked}
          >
            <SelectTrigger>
        ...
        <div className="flex items-center justify-between rounded-lg border p-3">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              setMasterField("isPurchasable", checked)
            }
            disabled={isLocked}
          />
        </div>
