...
const ShiftFormContext = React.createContext<ShiftFormContextValue | null>(
	null,
);
...
export function ShiftFormProvider({
	children,
}: {
...
export function useShiftForm(): ShiftFormContextValue {
	...
	if (!ctx)
		throw new Error("useShiftForm must be used inside <ShiftFormProvider>");
	return ctx;
}
