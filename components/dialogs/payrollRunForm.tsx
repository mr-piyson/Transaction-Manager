...
const PayrollRunFormContext =
	React.createContext<PayrollRunFormContextValue | null>(null);
...
export function PayrollRunFormProvider({
	children,
}: {
...
export function usePayrollRunForm(): PayrollRunFormContextValue {
	...
	if (!ctx)
		throw new Error(
			"usePayrollRunForm must be used inside <PayrollRunFormProvider>",
		);
	return ctx;
}
