...
const TrainingFormContext =
	React.createContext<TrainingFormContextValue | null>(null);
...
export function TrainingFormProvider({
	children,
}: {
...
export function useTrainingForm(): TrainingFormContextValue {
	...
	if (!ctx)
		throw new Error(
			"useTrainingForm must be used inside <TrainingFormProvider>",
		);
	return ctx;
}
