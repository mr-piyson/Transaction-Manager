...
const DocumentFormContext =
	React.createContext<DocumentFormContextValue | null>(null);
...
export function DocumentFormProvider({
	children,
}: {
...
export function useDocumentForm(): DocumentFormContextValue {
	...
	if (!ctx)
		throw new Error(
			"useDocumentForm must be used inside <DocumentFormProvider>",
		);
	return ctx;
}
