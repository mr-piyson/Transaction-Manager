...
export function EmployeeFormDialog({
	...
	const employeeTypes = Array.isArray(employeeTypesData)
		? employeeTypesData
		: ((employeeTypesData as any)?.data ?? []);
				...
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						...
						<Field orientation="vertical">
							...
							<DateInputField control={control} name="probationEndDate" />
						</Field>
						...
						<Field orientation="vertical">
							...
							<Select
								...
								onValueChange={(v) =>
									setValue("jobPositionId", v, { shouldValidate: true })
								}
							>
								<SelectTrigger>
						...
						<Field orientation="vertical">
							...
							<Select
								...
								onValueChange={(v) =>
									setValue("employeeTypeId", v, { shouldValidate: true })
								}
							>
								<SelectTrigger>
						...
						<Field orientation="vertical">
							...
							<Select
								...
								onValueChange={(v) =>
									setValue("reportsToId", v, { shouldValidate: true })
								}
							>
								<SelectTrigger>
...
const EmployeeFormContext =
	React.createContext<EmployeeFormContextValue | null>(null);
...
export function useEmployeeForm(): EmployeeFormContextValue {
	...
	if (!ctx)
		throw new Error(
			"useEmployeeForm must be used inside <EmployeeFormProvider>",
		);
	return ctx;
}
