            ...
            <div className="space-y-4 p-5 sm:p-6">
              ...
              <Card className="overflow-hidden">
                <CardContent className="p-4">
                  ...
                  {item.barcode ? (
                    <div className="overflow-x-auto rounded-lg border bg-white px-3 py-4">
                    ...
                    <div className="flex items-center justify-center rounded-lg border border-dashed bg-muted/20 px-4 py-8 text-sm text-muted-foreground">
                      No barcode assigned
                    </div>
                  )}
                </CardContent>
