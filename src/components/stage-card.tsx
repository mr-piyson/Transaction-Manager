...
import { Stage } from "@/layouts/Home/HomePage"
...
export function StageCard({
  ...
  return (
    <>
      <div
        className={cn(
          "relative flex gap-6 transition-all duration-300",
      ...
      >
        ...
        <div className="max-sm:hidden relative z-10 flex flex-col items-center">
          <div
            className={cn(
              "flex h-12 w-12 items-center justify-center rounded-full border-4 border-background transition-all duration-300",
              getStatusColor(),
            )}
          >
            {getStatusIcon()}
              ...
              <CardContent className="space-y-4 pt-0">
                ...
                <div className="space-y-3">
                  {stage.tasks.map((task, index) => (
                    <div
                      key={task.id}
                      className="group/task relative animate-in fade-in slide-in-from-left-2 duration-300"
                    ...
                    >
                      ...
                      >
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={() => onToggleTask(stage.id, task.id)}
                          className="h-5 w-5"
                        />
                        <label
                          htmlFor={task.id}
      ...
      <AlertDialog open={deleteStageOpen} onOpenChange={setDeleteStageOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{stage.title}"? This action cannot be undone and will remove all tasks in
              this stage.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
