...
export const getActivitiesForRole = (
    ...
    <>
      ...
      >
        <SidebarMenuButton
          isActive={isActive}
          className={cn(
            "group-data-[collapsible=icon]:p-1! flex data-[active=true]:bg-primary data-[active=false]:text-primary-foreground ",
            hasActiveDescendant && !isActive && "bg-primary/10"
          )}
          tooltip={item.title}
          size="default"
          onClick={handleClick}
          ...
          <div className=" flex items-center gap-2 flex-1 min-w-0">
            <i
              className={cn(
                " size-6 shrink-0",
                item.icon,
                isActive ? "text-white" : "text-foreground/92",
                isLoading && !showContent ? "hidden" : ""
              )}
            />
            ...
            <div className="flex items-center justify-between w-full min-w-0">
              ...
              <div className=" flex items-center gap-1 shrink-0">
                {isLoading && (
                  <Loader2 className="ms-1 size-4 animate-spin text-foreground/60" />
                )}
