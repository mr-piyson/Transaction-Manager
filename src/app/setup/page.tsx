            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  <Input id="slug" type="text" placeholder="acme-corp" value={formData.slug} onChange={handleSlugChange} required disabled={isLoading} className={`pr-10 ${slugStatus === 'available' ? 'border-green-500' : slugStatus === 'taken' ? 'border-red-500' : ''}`} />
