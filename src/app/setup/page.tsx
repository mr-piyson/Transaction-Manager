        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {slugStatus === 'taken' && (
                <p className="text-xs text-red-600">This slug is already taken. Please choose another.</p>
              )}
              ...
              {slugStatus === 'idle' && formData.slug.length > 0 && formData.slug.length < 3 && (
                <p className="text-xs text-muted-foreground">Slug must be at least 3 characters</p>
              )}
              {slugStatus === 'idle' && formData.slug.length === 0 && (
