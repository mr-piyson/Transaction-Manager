        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <nav className="flex items-center text-sm text-muted-foreground mb-2">
              <Link href="/app/inventory" className="hover:text-primary transition-colors flex items-center">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Edit the primary information for this inventory record.</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input name="code" id="code" defaultValue={item.code ?? ''} placeholder="e.g. SKU-12345" />
                    </div>
            ...
            <Card className="overflow-hidden border-dashed">
              ...
              <CardContent className="flex flex-col items-center justify-center p-0">
                {item.image ? (
                  ...
                  <img src={item.image} alt={item.name} className="w-full object-cover aspect-square" />
                ) : (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <Badge className={profit >= 0 ? 'bg-emerald-500/15 text-emerald-600 hover:bg-emerald-500/15' : ''}>
