...
export function InventoryCardRenderer(props: {
  data: InventoryItem;
  ...
  return (
    <div
      ...
      className="flex items-center gap-3 h-18 min-h-18 max-h-18 px-3.5 py-3 overflow-hidden"
    >
      {/* Avatar */}
