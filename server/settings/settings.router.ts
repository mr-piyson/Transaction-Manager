    ...
    delete: orgProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (existing.isDefault)
          throw new ConflictError("Cannot delete the default tax rate.");
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (existing)
          throw new ConflictError(
            `Account code "${input.code}" already exists.`,
          );
    ...
    delete: orgProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (existing.children.length > 0)
          throw new ConflictError(
            "Cannot delete an account with sub-accounts.",
          );
