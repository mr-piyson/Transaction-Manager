...
export const NAV_ITEMS = [
  ...
  {
    id: "sessions",
    labelKey: "settings.sessions",
    href: "/settings/sessions",
    icon: LogOut,
  },
  {
    id: "hrms",
    labelKey: "settings.hrms.title",
    href: "/settings/hrms",
    icon: Briefcase,
  },
  {
    id: "kiosks",
    labelKey: "settings.kiosks.title",
...
export function useActionHandlers() {
  ...
  return {
    handleSignOut,
    handleToggleTheme,
    handleSwitchLocale: switchLocale,
    theme,
    setTheme,
  };
}
