...
export const PERMISSIONS = [
  ...
  {
    code: "salary-component:read",
    label: "View Salary Components",
    module: "HRMS",
  },
  {
    code: "salary-component:create",
    label: "Create Salary Components",
    module: "HRMS",
  },
  {
    code: "salary-component:update",
    label: "Edit Salary Components",
    module: "HRMS",
  },
  {
    code: "salary-component:delete",
    label: "Delete Salary Components",
    module: "HRMS",
  },
  ...
  },
  {
    ...
    label: "Create Performance Reviews",
    module: "HRMS",
  },
  {
    code: "performance:update",
    label: "Edit Performance Reviews",
    module: "HRMS",
  },
  {
    code: "performance:delete",
    label: "Delete Performance Reviews",
    module: "HRMS",
  },
  {
    code: "performance:submit",
    label: "Submit Performance Reviews",
    module: "HRMS",
  },
  {
    code: "performance:acknowledge",
    label: "Acknowledge Performance Reviews",
    module: "HRMS",
  },
  ...
  {
    code: "employee-document:read",
    label: "View Employee Documents",
    module: "HRMS",
  },
  {
    code: "employee-document:create",
    label: "Upload Employee Documents",
    module: "HRMS",
  },
  {
    code: "employee-document:delete",
  ...
  {
    code: "disciplinary:read",
    label: "View Disciplinary Actions",
    module: "HRMS",
  },
  {
    code: "disciplinary:create",
    label: "Create Disciplinary Actions",
    module: "HRMS",
  },
  {
    code: "disciplinary:update",
    label: "Edit Disciplinary Actions",
    module: "HRMS",
  },
