...
export function useClipboard(): UseClipboardResult {
	...
	const [diagnose, setDiagnose] = useState<ClipboardDiagnostics>(
		ClipboardService.diagnose,
	);
	...
	const canCopy =
		diagnose.focused &&
		diagnose.visibilityState === "visible" &&
		ClipboardService.canUseClipboard();
